# IJPR-DSRCMPSP User Guides (Version 1.0)
...
* Satic, U., Jacko, P. and Kirkbride, C. (2022) ‘Performance evaluation of scheduling policies for the dynamic and stochastic resource-constrained multi-project scheduling problem’, _International Journal of Production Research_, 60(4), pp. 1411–1423. doi: 10.1080/00207543.2020.1857450.

An earlier version of this solver without stochastic task durations and ORBA method is used in: 

* Satic, U., Jacko, P., Kirkbride, C. (2020). ‘Performance Evaluation of Scheduling Policies for the DRCMPSP’, _Analytical and Stochastic Modelling Techniques and Applications. ASMTA 2019. Lecture Notes in Computer Science_, 12023. Springer, Cham. doi: 10.1007/978-3-030-62885-7_8.

## Introduction
IJPR-DSRCMPSP is a solver for dynamic and stochastic resource-constrained multi-project scheduling problems where projects generate rewards at their completion, completions later than a due date cause tardiness costs, task duration is uncertain, and new projects arrive randomly during the ongoing project execution both of which disturb the existing project scheduling plan. IJPR-DSRCMPSP contains the solution algorithms and benchmark problem information used in Satic (2022). These solution algorithms are: 
  * a dynamic programming algorithm to determine a policy that maximises the time-average profit,
  ...
  * a worst decision algorithm to seek a non-idling policy that minimises the time-average profit.
...
The source code of IJPR-DSRCMPSP is in the src folder.  Download the source code and open it with 1.00 version of Julia.  
